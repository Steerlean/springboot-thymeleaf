...
public class ContactRepositoryTest {
    ...
    public void findAll() {
        ...
        Assert.assertEquals(1, contactRepository.findAll().size());
        Assert.assertEquals("jay@gmail.com", contactRepository.findAll().get(0).getEmail());
        Assert.assertEquals("jayesh", contactRepository.findAll().get(0).getFirstName());
        Assert.assertEquals("ksh", contactRepository.findAll().get(0).getLastName());
    }
    ...
    public void findById() {
        ...
        Assert.assertEquals(true, contactRepository.findById(entity.getId()).isPresent());
    }
    ...
    public void deleteById() {
        ...
        Assert.assertEquals(0, contactRepository.findAll().size());
    }
}